...
-- Grant permissions to the app_user
GRANT SELECT, INSERT, UPDATE, DELETE ON windows_vm_agents TO app_user;
GRANT SELECT, INSERT, UPDATE, DELETE ON account_proxy_settings TO app_user;
GRANT SELECT, INSERT, UPDATE, DELETE ON default_proxy_settings TO app_user;
GRANT USAGE, SELECT ON SEQUENCE default_proxy_settings_id_seq TO app_user;
