...
INSERT INTO public.proxmox_nodes (name, hostname, port, owner_id, whitelist)
VALUES ('gpu1', '10.0.0.30', 8006, 2, '{1552,5001,5003,5004,5005,5006,5007,5008,5011,5012,5013,5014}');
