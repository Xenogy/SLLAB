...
with open(os.path.join('windows_vm_agent', '__init__.py'), 'r') as f:
    for line in f:
...
with open(os.path.join('windows_vm_agent', 'README.md'), 'r', encoding='utf-8') as f:
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'windows-vm-agent=windows_vm_agent.main:main',
        ],
    },
    classifiers=[
