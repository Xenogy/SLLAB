...
export function DataTable<TData, TValue>({
  ...
  // Find the first available column if the specified filterColumn doesn't exist
  const availableColumns = table.getAllColumns().map(column => column.id)
  const filterColumnExists = availableColumns.includes(filterColumn)
  const actualFilterColumn = filterColumnExists ? filterColumn : availableColumns[0]
